...
*Defined in [src/jsonbin-logger.ts:49](https://github.com/nju33/logger/blob/2cda14a/src/jsonbin-logger.ts#L49)*
...
*Defined in [src/jsonbin-logger.ts:55](https://github.com/nju33/logger/blob/2cda14a/src/jsonbin-logger.ts#L55)*

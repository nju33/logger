...
*Defined in [src/jsonbin-logger.ts:48](https://github.com/nju33/logger/blob/2f39b9a/src/jsonbin-logger.ts#L48)*
...
*Defined in [src/jsonbin-logger.ts:54](https://github.com/nju33/logger/blob/2f39b9a/src/jsonbin-logger.ts#L54)*

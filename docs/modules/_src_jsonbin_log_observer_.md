...
*Defined in [src/jsonbin-log-observer.ts:13](https://github.com/nju33/logger/blob/2cda14a/src/jsonbin-log-observer.ts#L13)*
...
*Defined in [src/jsonbin-log-observer.ts:19](https://github.com/nju33/logger/blob/2cda14a/src/jsonbin-log-observer.ts#L19)*

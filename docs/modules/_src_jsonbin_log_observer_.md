...
*Defined in [src/jsonbin-log-observer.ts:13](https://github.com/nju33/logger/blob/9b2a4b5/src/jsonbin-log-observer.ts#L13)*
...
*Defined in [src/jsonbin-log-observer.ts:19](https://github.com/nju33/logger/blob/9b2a4b5/src/jsonbin-log-observer.ts#L19)*

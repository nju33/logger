...
*Defined in [src/logger.ts:4](https://github.com/nju33/logger/blob/22b1f74/src/logger.ts#L4)*
...
*Defined in [src/logger.ts:39](https://github.com/nju33/logger/blob/22b1f74/src/logger.ts#L39)*
...
*Defined in [src/logger.ts:45](https://github.com/nju33/logger/blob/22b1f74/src/logger.ts#L45)*

#### Type declaration:

▸ (`log`: [LoggerLogVo](_src_logger_.md#loggerlogvo)): *PromiseLike‹void›*
...
*Defined in [src/logger.ts:57](https://github.com/nju33/logger/blob/22b1f74/src/logger.ts#L57)*

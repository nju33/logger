...
*Defined in [src/logger.ts:4](https://github.com/nju33/logger/blob/2cda14a/src/logger.ts#L4)*
...
*Defined in [src/logger.ts:33](https://github.com/nju33/logger/blob/2cda14a/src/logger.ts#L33)*
...
*Defined in [src/logger.ts:39](https://github.com/nju33/logger/blob/2cda14a/src/logger.ts#L39)*
...
*Defined in [src/logger.ts:60](https://github.com/nju33/logger/blob/2cda14a/src/logger.ts#L60)*
